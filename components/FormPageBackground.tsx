      ...
      <Col span={4}>
        <Group>
          <Paper shadow="0.5em 0.5em 0.5em rgba(101, 101, 101, 0.685)">
            <img src="/images/beyaz1.jpg" alt="beyaz1" />
          </Paper>
          <Paper shadow="0.5em 0.5em 0.5em rgba(101, 101, 101, 0.685)">
            <img src="/images/beyaz2.jpg" alt="beyaz2" />
          </Paper>
        </Group>
      </Col>
      <Col span={4}>
        <Group>
          <Paper shadow="0.5em 0.5em 0.5em rgba(101, 101, 101, 0.685)">
            <img src="/images/beyaz3.jpg" alt="beyaz3" />
          </Paper>
          <Paper shadow="0.5em 0.5em 0.5em rgba(101, 101, 101, 0.685)">
            <img src="/images/beyaz4.jpg" alt="beyaz4" />
          </Paper>
        </Group>
      </Col>
      <Col span={4}>
        <Group>
          <Paper shadow="0.5em 0.5em 0.5em rgba(101, 101, 101, 0.685)">
            <img src="/images/beyaz5.jpg" alt="beyaz5" />
          </Paper>
          <Paper shadow="0.5em 0.5em 0.5em rgba(101, 101, 101, 0.685)">
            <img src="/images/beyaz6.jpg" alt="beyaz6" />
          </Paper>
        </Group>
      </Col>
    </Grid>
