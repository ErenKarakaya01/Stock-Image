...
let connection: any = mysql.createConnection(process.env.MYSQL_URI || "mysql://b7c317a6536a15:e01681c5@eu-cdbr-west-03.cleardb.net/heroku_fb154a1c8e2c548?reconnect=true")
